...
public class JanelaDeJogo extends JFrame {
    ...
    private SolverCampoMinado solver; // <-- solver integrado

    public JanelaDeJogo(CampoMinado campoMinado, TabelaRecordes recordes) {
        this.campoMinado = campoMinado;
        this.recordes = recordes;
        this.solver = new SolverCampoMinado(campoMinado); // inicializa o solver
        ...
        // Foco inicial para capturar teclas
    ...
    KeyListener keyListener = new KeyListener() {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            switch (e.getKeyCode()) {
                ...
                // <-- Atalho do Solver
                case KeyEvent.VK_S -> {
                    boolean fezAlgo = solver.passo(); // só um passo
                    if (!fezAlgo) {
                        JOptionPane.showMessageDialog(null,
                                "Não há jogadas óbvias restantes!",
